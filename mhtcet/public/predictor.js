...
let metadata = {
    cities: ["Pune", "Mumbai", "Navi Mumbai", "Thane", "Pimpri-Chinchwad", "Nashik", "Nagpur", "Chhatrapati Sambhajinagar", "Kolhapur", "Solapur", "Sangli", "Jalgaon", "Amravati", "Dhule", "Shirpur", "Nanded", "Latur", "Satara", "Ratnagiri", "Ahmednagar", "Akola", "Buldhana", "Yavatmal", "Chandrapur"],
    universities: ["Savitribai Phule Pune University", "Mumbai University", "Dr. Babasaheb Ambedkar Technological University, Lonere", "Shivaji University, Kolhapur", "Dr. Babasaheb Ambedkar Marathwada University, Chhatrapati Sambhajinagar", "Sant Gadge Baba Amravati University", "Rashtrasant Tukadoji Maharaj Nagpur University", "Kavayitri Bahinabai Chaudhari North Maharashtra University, Jalgaon", "Swami Ramanand Teerth Marathwada University, Nanded", "Punyashlok Ahilyadevi Holkar Solapur University", "Gondwana University"],
    branches: ["Computer Engineering", "Information Technology", "Artificial Intelligence And Data Science", "Artificial Intelligence And Machine Learning", "Electronics And Telecommunication Engg", "Mechanical Engineering", "Civil Engineering", "Electrical Engineering"],
...
let selectedCollegeKeys = new Set();

function getCollegeKey(col) {
    return (col.choice_code || col.branch_code || '') + '_' + (col.college_code || '') + '_' + (col.branch_name || '');
}
...
// View Mode Switching Listeners (Cards View vs Table View)
if (viewBtnCards) {
...
if (percentileRange && percentileNum) {
...
function initBranches() {
    ...
    if (typeof Sortable !== 'undefined' && branchPriorityList) {
...
// Fallback offline prediction generator when backend API is unreachable
function generateFallbackColleges(payload) {
    const userPct = payload.percentile || 95.5;
    const userCategory = payload.category || "Open";
    const userGender = payload.gender || "Male";

    const baseColleges = [
        { name: "COEP Technological University, Pune", city: "Pune", code: "1001", type: "Government", autonomy: "Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "Veermata Jijabai Technological Institute (VJTI), Mumbai", city: "Mumbai", code: "3012", type: "Government", autonomy: "Autonomous", uni: "Mumbai University" },
        { name: "Pune Institute of Computer Technology (PICT), Pune", city: "Pune", code: "6271", type: "PRIVATE", autonomy: "Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "Vishwakarma Institute of Technology (VIT), Pune", city: "Pune", code: "6273", type: "PRIVATE", autonomy: "Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "Sardar Patel Institute of Technology (SPIT), Mumbai", city: "Mumbai", code: "3014", type: "PRIVATE", autonomy: "Autonomous", uni: "Mumbai University" },
        { name: "Walchand College of Engineering, Sangli", city: "Sangli", code: "6006", type: "Government", autonomy: "Autonomous", uni: "Shivaji University" },
        { name: "Pimpri Chinchwad College of Engineering (PCCOE), Pune", city: "Pune", code: "6175", type: "PRIVATE", autonomy: "Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "Dwarkadas J. Sanghvi College of Engineering, Mumbai", city: "Mumbai", code: "3182", type: "PRIVATE", autonomy: "Autonomous", uni: "Mumbai University" },
        { name: "Government College of Engineering, Karad", city: "Satara", code: "6005", type: "Government", autonomy: "Autonomous", uni: "Shivaji University" },
        { name: "Government College of Engineering, Chhatrapati Sambhajinagar", city: "Aurangabad", code: "2001", type: "Government", autonomy: "Autonomous", uni: "Dr. Babasaheb Ambedkar Marathwada University" },
        { name: "MKSSS's Cummins College of Engineering for Women, Pune", city: "Pune", code: "6276", type: "PRIVATE", autonomy: "Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "AISSMS College of Engineering, Pune", city: "Pune", code: "6278", type: "PRIVATE", autonomy: "Non-Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "K. J. Somaiya College of Engineering, Mumbai", city: "Mumbai", code: "3027", type: "PRIVATE", autonomy: "Autonomous", uni: "Mumbai University" },
        { name: "Shri Guru Gobind Singhji Institute (SGGS), Nanded", city: "Nanded", code: "2020", type: "Government", autonomy: "Autonomous", uni: "Swami Ramanand Teerth Marathwada University, Nanded" },
        { name: "MIT Academy of Engineering, Alandi, Pune", city: "Pune", code: "6146", type: "PRIVATE", autonomy: "Autonomous", uni: "Savitribai Phule Pune University" },
        { name: "Government College of Engineering, Amravati", city: "Amravati", code: "1002", type: "Government", autonomy: "Autonomous", uni: "Sant Gadge Baba Amravati University" },
        { name: "Ramdeobaba University (RCOEM), Nagpur", city: "Nagpur", code: "4115", type: "PRIVATE", autonomy: "Autonomous", uni: "Rashtrasant Tukadoji Maharaj Nagpur University" },
        { name: "Government College of Engineering, Nagpur", city: "Nagpur", code: "4025", type: "Government", autonomy: "Non-Autonomous", uni: "Rashtrasant Tukadoji Maharaj Nagpur University" },
        { name: "Government College of Engineering, Jalgaon", city: "Jalgaon", code: "5003", type: "Government", autonomy: "Non-Autonomous", uni: "Kavayitri Bahinabai Chaudhari North Maharashtra University, Jalgaon" },
        { name: "Modern Education Society's Wadia College of Engineering, Pune", city: "Pune", code: "6281", type: "PRIVATE", autonomy: "Non-Autonomous", uni: "Savitribai Phule Pune University" }
    ];
    ...
    baseColleges.forEach((col, idx) => {
        branches.forEach((branch, bIdx) => {
            let baseCutoff = 99.8 - (idx * 0.75) - (bIdx * 0.35);
            if (baseCutoff < 50) baseCutoff = 50 + (idx % 10);
            baseCutoff = Math.min(99.98, Math.max(50.0, baseCutoff));

            let status = "Moderate";
            let diff = userPct - baseCutoff;
            if (diff >= 1.5) status = "Safe";
            else if (diff <= -2.0) status = "Dream";
            else status = "Moderate";

            const codeStr = col.code + String(10 + bIdx) + "10";
            ...
            results.push({
                ...
                branch_code: codeStr,
                branch_name: branch,
                seat_category: userCategory === "Open" ? "GOPENH" : userCategory,
                closing_cutoff: parseFloat(baseCutoff.toFixed(4)),
                opening_cutoff: parseFloat((baseCutoff + 1.25).toFixed(4)),
                cutoff_percentile: parseFloat(baseCutoff.toFixed(4)),
                cutoff_rank: Math.round((100 - baseCutoff) * 1200),
                choice_code: codeStr,
                cap_round: payload.cap_round || "CAP Round 1",
                status: status
            });
        });
    });

    if (payload.preferred_cities && payload.preferred_cities.length > 0) {
        const filteredCities = results.filter(r => payload.preferred_cities.includes(r.city));
        if (filteredCities.length > 0) results = filteredCities;
    }

    if (payload.preferred_branches && payload.preferred_branches.length > 0) {
        const filteredBranches = results.filter(r => payload.preferred_branches.some(b => r.branch_name.toLowerCase().includes(b.toLowerCase())));
        if (filteredBranches.length > 0) results = filteredBranches;
    }

    results.sort((a, b) => b.closing_cutoff - a.closing_cutoff);
...
predictorForm.addEventListener("submit", async (e) => {
    ...
    const percentileVal = parseFloat(percentileNum.value);
...
// Multi-Select & Batch Deletion Helper Functions
window.toggleSelectCollegeKey = function(key) {
    if (selectedCollegeKeys.has(key)) {
        selectedCollegeKeys.delete(key);
    } else {
        selectedCollegeKeys.add(key);
    }
    updateSelectedCollegesUI();
};

window.toggleSelectAllColleges = function(headerCheckbox) {
    const visibleCheckboxes = document.querySelectorAll(".college-select-checkbox");
...
function updateSelectedCollegesUI() {
    const toolbar = document.getElementById("bulk-actions-toolbar");
    const badge = document.getElementById("selected-count-badge");
    const numSpan = document.getElementById("delete-count-num");
    const mainDeleteSpan = document.getElementById("main-delete-count");
    const barDeleteSpan = document.getElementById("bar-delete-count");
    const count = selectedCollegeKeys.size;

    if (mainDeleteSpan) mainDeleteSpan.textContent = count;
    if (barDeleteSpan) barDeleteSpan.textContent = count;

    if (count > 0) {
        if (toolbar) toolbar.style.display = "flex";
        if (badge) badge.textContent = `${count} College${count > 1 ? 's' : ''} Selected`;
...
window.clearSelectedColleges = function() {
    selectedCollegeKeys.clear();
    const selectAllCb = document.getElementById("select-all-colleges");
    if (selectAllCb) selectAllCb.checked = false;
    document.querySelectorAll(".college-select-checkbox").forEach(cb => cb.checked = false);
    updateSelectedCollegesUI();
};

window.deleteSelectedColleges = function() {
    if (selectedCollegeKeys.size === 0) {
        showToast("Please check at least one college checkbox to delete.");
        return;
    }
    const count = selectedCollegeKeys.size;

    allResultsData = allResultsData.filter(col => !selectedCollegeKeys.has(getCollegeKey(col)));
    selectedCollegeKeys.clear();
    ...
    updateSelectedCollegesUI();
    renderResultsView();
    showToast(`Deleted ${count} selected college${count > 1 ? 's' : ''}. Option list updated!`);
};

window.deleteSingleCollegeByKey = function(key) {
    const targetIndex = allResultsData.findIndex(col => getCollegeKey(col) === key);
    if (targetIndex === -1) return;

    const collegeName = allResultsData[targetIndex].college_name;
    allResultsData.splice(targetIndex, 1);
    selectedCollegeKeys.delete(key);
    ...
    updateSelectedCollegesUI();
    renderResultsView();
    showToast(`Removed "${collegeName}" from option list.`);
};

window.copySelectedChoiceCodes = function() {
    if (selectedCollegeKeys.size === 0) {
        showToast("No colleges selected.");
        return;
    }
    const selectedCols = allResultsData.filter(col => selectedCollegeKeys.has(getCollegeKey(col)));
    const codes = selectedCols.map(col => formatIntCode(col.branch_code || col.choice_code || col.college_code)).filter(Boolean);

    if (codes.length === 0) {
        showToast("No choice codes found for selected colleges.");
        return;
    }
    navigator.clipboard.writeText(codes.join("\n")).then(() => {
        showToast(`Copied ${codes.length} choice codes to clipboard!`);
    });
};

// Render Table View Matching User Format:
// Checkbox | Rank | College Name | Branch | Choice Code | Cutoff % | Location | Type | Remove
function renderTableView(displayList, startIndex) {
    ...
    displayList.forEach((col, idx) => {
        const itemKey = getCollegeKey(col);
        const isChecked = selectedCollegeKeys.has(itemKey);
        ...
        tr.innerHTML = `
            <td class="col-select" style="text-align: center;">
                <input type="checkbox" class="college-select-checkbox" data-key="${itemKey}" ${isChecked ? 'checked' : ''} onchange="event.stopPropagation(); toggleSelectCollegeKey('${itemKey}')">
            </td>
            <td class="col-rank">
            ...
            <td class="col-action" style="text-align: center;">
                <button type="button" class="row-delete-btn" title="Remove college from list" onclick="event.stopPropagation(); deleteSingleCollegeByKey('${itemKey}')">
        ...
        const openModalHandler = (e) => {
            if (e.target.closest(".table-pref-input-wrap") || e.target.closest(".college-select-checkbox") || e.target.closest(".row-delete-btn")) return;
            e.stopPropagation();
...
function renderCardsView(displayList, startIndex) {
    ...
    displayList.forEach((col, idx) => {
        ...
        const pdfPage = col.pdf_page_number || col.PDF_Page_Number || col.pdf_page;

        card.innerHTML = `
            <div class="card-header-bar">
                <div class="card-header-left">
                    <input type="checkbox" class="college-select-checkbox" data-key="${itemKey}" ${isChecked ? 'checked' : ''} onchange="event.stopPropagation(); toggleSelectCollegeKey('${itemKey}')" title="Select college">
            ...
            <body>
                ...
                <div class="footer-bar">
                    <div class="footer-left">
                        Generated using <strong>MHT-CET AI College Predictor & CAP Counselling Platform</strong>
                    </div>
